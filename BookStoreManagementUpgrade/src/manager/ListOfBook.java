...
public class ListOfBook {
    ...
    public void printListOfBook() {
        for (Book book : listBook) book.printBookInformation();
    }
    ...
    public void updateBookByID(String bookID) {
        ...
        if (findBookByID(bookID) == null)  System.out.println("Book does not exist!");
        else {
            ...
            do {
                try {
                    ...
                    System.out.print("Add another book's ISBN: ");
                    stillAdd = true;
                }
            } while (stillAdd);
    ...
    public Book findBookByAuthorName(String text) {
        for (Book bookInformation : listBook) {
            if (bookInformation.getAuthor().getName().equals(text))
                return bookInformation;
        } 
        return null;
    }
    ...
    public void searchAllBookByAuthorName(String text) {
        if (findBookByAuthorName(text) == null) System.out.println("No book is matched!");
        else {
    ...
    public void storeDataToFile() {
        ...
        try {
            ...
            for (Book bookInformation : listBook) fo.writeObject(bookInformation);
            fo.close(); f.close();
        } catch (Exception e) {
    ...
    public void storeAuthorInformationToFile() {
        ...
        try {
            ...
            ObjectOutputStream fo = new ObjectOutputStream(f);
            for (Book bookInformation : listBook) fo.writeObject(bookInformation.getAuthor());
            fo.close(); f.close();
        } catch (Exception e) {
            System.out.println(e);
        }
